...
/**
 * Write a description of class Human_Pistol here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Human_Pistol extends Humans
{
    /**
     ...
     */
    public Human_Pistol(int direction,int newHP,boolean pistol, boolean ak47, boolean spas12, boolean m60) {
